...
const accessToken = "pk.eyJ1Ijoia2J5MTQ0MCIsImEiOiJjbTM2cjh0ejAwOGp0Mm9wd21lcGllb2wxIn0.3aO3C16DypDlWWWo_qQviw";
let map;
...
const addMarker = (feature, className, clickHandler) => {
	// A. create a mpa marker using featuree (i.e. "Park") data
	// - the marker is a <div>
	// - <div> gets id of the "feature"
